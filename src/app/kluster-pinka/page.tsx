...
const DATA = {
  ...
  description:
    "Menghadirkan harmoni antara material jujur dan alam Berbah yang asri. Hunian modern tropis di Yogyakarta ini dirancang untuk ketenangan hidup maksimal dengan sirkulasi udara optimal dan pencahayaan alami.",
  gallery: [
    {
      src: "/assets/images/pinka/1.svg",
      label: "Titik Huni - Pesona Pinka",
    },
    {
      src: "/assets/images/pinka/2.svg",
      label: "Konsep Desain",
    },
    {
      src: "/assets/images/pinka/3.svg",
      label: "Estetika Bangunan",
    },
    { src: "/assets/images/pinka/4.svg", 
      label: "Ruang Tamu Terlihat Segar" },
    {
      src: "/assets/images/pinka/5.svg",
      label: "Konsep Batu",
    },
    { src: "/assets/images/pinka/6.svg", 
      label: "Pencahayaan Alami" 
    },
    { src: "/assets/images/pinka/7.svg", 
      label: "View Malam Hari" 
    },
    { src: "/assets/images/pinka/8.svg", 
  ...
  priceRaw: 550000000,
  waLink:
    "https://wa.me/6289509888404?text=Halo Titik Huni, saya tertarik dengan Pesona Pinka",
};
